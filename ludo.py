...
if __name__ == '__main__':
    ...
    block_six_side = ImageTk.PhotoImage(Image.open("6_block.png").resize((33, 33), Image.LANCZOS))
    block_five_side = ImageTk.PhotoImage(Image.open("5_block.png").resize((33, 33), Image.LANCZOS))
    block_four_side = ImageTk.PhotoImage(Image.open("4_block.png").resize((33, 33), Image.LANCZOS))
    block_three_side = ImageTk.PhotoImage(Image.open("3_block.png").resize((33, 33), Image.LANCZOS))
    block_two_side = ImageTk.PhotoImage(Image.open("2_block.png").resize((33, 33), Image.LANCZOS))
    block_one_side = ImageTk.PhotoImage(Image.open("1_block.png").resize((33, 33), Image.LANCZOS))
